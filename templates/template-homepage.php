...
<a href="#<?php echo sanitize_title( str_replace( get_permalink(), '', get_field('homepage_cta_link', $pageId) ) ); ?>" class="btn ctaLink"><?php the_field('homepage_cta_text', $pageId); ?></a>
<?php 
endif;
...
<ul class="socialNetworkLink socicon">
	...
	<li><a href="<?php the_sub_field("theme_social_icons_links") ?>" class="btn socicon-<?php the_sub_field("theme_social_icons_sites") ?>" target="_blank"></a></li>
	<?php
	endwhile; ?>
